...
# install clangd-15
CLANGD_URL="https://github.com/clangd/clangd/releases/download/15.0.6/clangd-linux-19.1.2.zip"
cd "${SETUP_DIR}"
curl -LOk ${CLANGD_URL}
unzip -o clangd-linux-15.0.6.zip
...
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-json@1.8.0' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-jedi@0.30.1' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-diagnostic@0.24.0' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-clangd@0.29.0' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-prettier@9.3.2' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-eslint@1.6.0' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-tsserver@2.1.3' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-html@1.8.0' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-css@2.0.0' +qa
VIMLSP=yes ${LOCAL_DIR}/bin/nvim +'CocInstall -sync coc-explorer@0.26.5' +qa
